...
@aot_dso_cache = dso_local local_unnamed_addr global [846 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-System.ComponentModel.Annotations.dll.so
		ptr null; void* handle
	}, ; 123
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x41eb16f575aa5c8f, ; from name: aot-GroceryApp.dll.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	}, ; 210
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x585d00ad65a6e8a3, ; from name: aot-GroceryApp
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8eb5f59d4e5d8d09, ; from name: libaot-GroceryApp.dll.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9903abcbaf9c22f4, ; from name: aot-GroceryApp.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xabbf80a343632220, ; from name: libaot-GroceryApp
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xaca555d2fc5a69fa, ; from name: GroceryApp.dll.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb8eec98583317f5c, ; from name: GroceryApp.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc92974bcc0085d28, ; from name: libaot-GroceryApp.so
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xea160aa9afdc0380, ; from name: GroceryApp
		i64 u0x8eb5f59d4e5d8d09, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GroceryApp.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.groceryapp.mobile\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-GroceryApp.dll.so\00", align 1
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [48 x i8] c"libaot-System.ComponentModel.Annotations.dll.so\00", align 1
